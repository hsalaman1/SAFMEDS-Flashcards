...
export function FillBlankQuestion({ question, onSubmit, isAnswered, hintText, hintAvailable, onRequestHint }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-5 w-full max-w-xl">
      <p className="text-xs text-zinc-500 uppercase tracking-wider">
        {card.chapter !== null ? `Chapter ${card.chapter} — ` : ''}Fill in the blank
      </p>
      ...
      {/* Masked term */}
      <div className="px-6 py-4 rounded-xl bg-zinc-800 border border-zinc-700 w-full text-center">
        <p className="text-2xl font-mono text-teal-400 tracking-widest">
          {question.maskedTerm}
        </p>
      </div>
